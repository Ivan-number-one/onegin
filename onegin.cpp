...
int main(int argc, char** argv)
{
	...
	// my_qsort(strings, 0, nStrings - 1, comparator);
	qsort1;
	my_qsort1;
	output_file(nStrings, strings, "w");

	// qsort(strings, nStrings, sizeof (str), &reverse_comparator);
	// my_qsort(strings, 0, nStrings - 1, reverse_comparator);
	qsort2;
	my_qsort2;
